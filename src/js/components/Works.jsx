			...
			<div className={'ui basic center aligned segment'}>
				...
				<div className="ui stackable eight column grid">
					...
					<div className="ten wide column">
						...
						<p><I18n sign='works.des4'>In our Core event, we are issueing Choice Award, Technical Award, Visual Design Award, and Presentation Award, mainly to encourage a more polished result from our participants. Different professionals of the awards are invited to assess the prototypes and presentations. Aside from techniques, presentation became also a topic of award from its nature as a solid skill.</I18n></p>
